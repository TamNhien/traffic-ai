...
Ensure-EnvSetting "AI_BICYCLE_CONSENSUS_CONF" "0.60"
Ensure-EnvSetting "AI_BICYCLE_CONSENSUS_MIN_HITS" "3"
Ensure-EnvSetting "AI_BICYCLE_CONSENSUS_MARGIN" "0.08"
Ensure-EnvSetting "AI_BICYCLE_CONSENSUS_MIN_STRONG" "0.34"
...
Write-Host ""
Write-Host "[OK] Traffic AI V0.5.29 đã khởi động." -ForegroundColor Green
